...
import 'package:hastapos/utils/snackbar_custom/snackbar_widget.dart';

class SnackbarUtilsController {
  ...
  final SnackBarUtilsWidget snackbar;
  ...
  SnackbarUtilsController(this.snackbar);
...
class _SnackBarQueue {
  ...
  final _snackbarList = <SnackbarUtilsController>[];

  SnackbarUtilsController? get _currentSnackbar {
  ...
  Future<void> _addJob(SnackbarUtilsController job) async {
